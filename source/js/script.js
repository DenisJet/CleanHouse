...
if (window.location.href !== 'https://cleanhouse-ses.ru/thanks.html') {
  ...
  document.addEventListener('click', (evt) => {
    if (evt.target.classList.contains('button') || evt.target.classList.contains('filials__item')) {
      openPopup();
    }
  })
}
...
if (document.querySelector('.o-kompanii')) {
  ...
  const sliderCloseButton = slider.querySelector('.slider-sertificats__button--close');
